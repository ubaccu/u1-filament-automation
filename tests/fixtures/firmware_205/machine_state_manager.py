...
class MachineMainState(IntEnum):
    ...
    STEPPER_RESONANCE_CALIBRATE = 14 # stepper resonance factory calibration
...
class ActionCode(IntEnum):
    ...
    # stepper resonance calibration
    STEPPER_RESONANCE_CALIBRATING = 896
...
DEFAULT_TRANSITION_RULES = {
    ...
    MachineMainState.STEPPER_RESONANCE_CALIBRATE: [MachineMainState.IDLE]
}
...
DEFAULT_EXIT_RULES = {
    ...
    MachineMainState.STEPPER_RESONANCE_CALIBRATE: {MachineMainState.STEPPER_RESONANCE_CALIBRATE}
}

...
class Final181DistributionTests(unittest.TestCase):
    def test_version_is_1_8_3_beta_everywhere(self):
        self.assertEqual(u1_filament_automation.__version__, "1.8.3b2")
        pyproject = (ROOT / "pyproject.toml").read_text(encoding="utf-8")
        self.assertIn('version = "1.8.3b2"', pyproject)
        self.assertTrue((ROOT / "RELEASE_NOTES_1.8.3b2.md").is_file())

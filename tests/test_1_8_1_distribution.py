...
class Final181DistributionTests(unittest.TestCase):
    def test_version_is_1_8_3_everywhere(self):
        self.assertEqual(u1_filament_automation.__version__, "1.8.3")
        pyproject = (ROOT / "pyproject.toml").read_text(encoding="utf-8")
        self.assertIn('version = "1.8.3"', pyproject)
        self.assertTrue((ROOT / "RELEASE_NOTES_1.8.3.md").is_file())

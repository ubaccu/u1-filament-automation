...
class FlowCalibrator(object):
    ...
    def cmd_FLOW_CALIBRATE(self, gcmd):
        ...
        if chain_mode:
            gcmd.respond_info(
                f'[flow_calibrate] APA CHAIN v6: CHAIN=1 CHAIN_LAST={chain_last} '

...
def _hero(language: str) -> str:
    ...
    return (
        ...
        '<span class=\"u1fa-final-chip\"><span class=\"u1fa-badge-icon orca\">O</span>Orca Slicer</span>'

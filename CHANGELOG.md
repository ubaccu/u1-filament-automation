...
- La calibrazione U1FA usa la modalità MEASURE-ONLY: restituisce i cinque K senza sovrascrivere il Flow K nativo Snapmaker.
...
- Aggiunto il riconoscimento read-only del firmware U1 2.0.0.205 tramite
  versione completa e SHA-256 dei componenti Klipper.
- Abilitata l'installazione protetta del porting AutoPA dedicato solo sulla build
  2.0.0.205 esatta e con tutti gli hash delle dipendenze convalidati.
- La calibrazione 2.0.0 resta bloccata finché modulo AutoPA e macro non risultano
  entrambi riconosciuti; versioni future e componenti sconosciuti restano bloccati.
- Aggiunti fixture del firmware 1.5.2 e 2.0.0.205, calibratore stock 2.0.0.205
  e porting AutoPA dedicato con test di selezione, backup e ripristino sandbox.
- Lo stato macchina mancante o non interpretabile non è più considerato sicuro.

## 1.8.2 — 2026-09-13

- Nuova eliminazione guidata di filamenti e bobine collegate.
- Possibilità di rimandare la calibrazione PA dopo la creazione di una bobina.
- Nuova Home e navigazione multipiattaforma.
- Selettore filamenti e gestione profili Orca migliorati.

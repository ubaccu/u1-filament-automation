...
Per il firmware U1 2.0.0.205 la Beta 1 può proporre l'installazione protetta solo
quando versione completa, dipendenze e calibratore originale coincidono con gli
hash convalidati. Il primo collaudo reale deve fermarsi dopo il controllo in sola
lettura e far verificare il report prima di confermare la scrittura. Dopo
l'installazione è obbligatorio il power cycle completo; la calibrazione resta
bloccata finché modulo AutoPA e macro non risultano entrambi riconosciuti.
